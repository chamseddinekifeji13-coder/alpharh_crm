  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        <div>
          <h1 className="text-4xl font-semibold tracking-tight text-slate-900">Catalogue Inter</h1>
          <p className="text-slate-500 mt-2 text-lg font-light">Programmez et gérez vos sessions de formation collectives.</p>
        </div>
        <button 
